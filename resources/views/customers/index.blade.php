...
@section('content-header', __('Member List'))
...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="search-box">
            ...
            <input type="text" id="customerSearch" class="form-control" placeholder="{{ __('Search Members') }}">
        </div>
    </div>
    <div class="col-md-6">
...
<div class="row mb-4">
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="dashboard-card card-total">
            ...
            <div class="card-title">{{ __('Total Members') }}</div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="dashboard-card card-new">
            ...
            <div class="card-title">{{ __('New Members (30 days)') }}</div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="dashboard-card card-returning">
            ...
            <div class="card-text">
                <div class="card-title">{{ __('Returning Members') }}</div>
...
<!-- Member List Table -->
<div class="card member-list shadow-sm border-0">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h3 class="m-0">{{ __('Member List') }}</h3>
        ...
        <table class="table table-hover text-nowrap align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$customer->id}}</td>
                    <td>
                        <img class="customer-avatar" src="{{$customer->getAvatarUrl()}}" alt="Member Avatar">
                    </td>
                    <td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customerDetailModalLabel">{{ __('Member Detail') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div id="customerDetailContent" style="display: none;">
                    <div class="text-center mb-4">
                        <img id="modal-customer-avatar" class="customer-avatar" style="width: 100px; height: 100px;" src="" alt="Member Avatar">
                        <h4 id="modal-customer-name" class="mt-3"></h4>
                    </div>
                    <div class="customer-details">
                        <div class="customer-info-row">
                            <strong><i class="fas fa-envelope"></i> {{ __('member.Email') }}:</strong>
                            <span id="modal-customer-email"></span>
                        </div>
                        <div class="customer-info-row">
                            <strong><i class="fas fa-phone-alt"></i> {{ __('member.Phone') }}:</strong>
                            <span id="modal-customer-phone"></span>
                        </div>
                        <div class="customer-info-row">
                            <strong><i class="fas fa-map-marker-alt"></i> {{ __('member.Address') }}:</strong>
