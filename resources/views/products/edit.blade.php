...
<div class="card">
    <div class="card-header">
        <h3><i class="fas fa-edit mr-2"></i>{{ __('product.Edit_Product') }}</h3>
    </div>
    <div class="card-body">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="current-image-container">
                        <img src="{{ Storage::url($product->image) }}" alt="Current product image" class="current-image">
                        <span class="current-image-label">{{ __('Current Image') }}</span>
                    </div>
                    @endif
                </div>
            </div>
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    if ($('.current-image-container').length) {
                        ...
                        $('.current-image-label').text('{{ __("New Image Preview") }}');
                    } else {
                        const imagePreview = `
                            <div class="current-image-container">
                                <img src="${e.target.result}" alt="New image preview" class="current-image">
                                <span class="current-image-label">{{ __("New Image Preview") }}</span>
                            </div>
                        `;
